...
func (t Tag) List (c *gin.Context){
	...
	if !valid {
		...
		errRep := errcode.InvalidParams.WithDetails(errs.Errors()...)
	...
	tag, err := svc.GetTagList(&param, &pager)
	if err != nil {
	...
	response.ToResponseList(tag, totalRows)
...
func (t Tag) Delete (c *gin.Context){
	...
	if err != nil {
		global.Logger.Errorf("svc.DeleteTag errs: %v", errs)
